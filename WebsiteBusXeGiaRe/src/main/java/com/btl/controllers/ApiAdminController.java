...
public class ApiAdminController {
    ...
    public ResponseEntity<List<Object>> getproductStatsPeriod(@RequestBody Map<String, String>
            params, Model model) {
        try {
            ...
            List<Object> list = this.statisticService.ProductStatsPeriod(fromDate, toDate);
