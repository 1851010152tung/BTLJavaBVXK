...
<!--                                        <th>
                                        ...
                                        <th class="column-title" id="col-image">Avatar </th>                                        
...
<!--                                        <td class="a-center ">
                                        ...
                                        <td class=" ">${e.idEmployee}</td>
                                        <td class=" ">${e.firstName}</td>
                                        <td class=" ">${e.lastName}</td>
                                        <td class=" ">${e.username}</td>
                                        <td class=" ">${e.position}</td>                                        
                                        <td class=" ">${e.phone}</td>
                                        <td class=" ">${e.email}</td>
                                        <td class=" ">${e.gender}</td>
                                        <td class=" ">${e.birthday}</td>                                        
                                        <td>
                                            <c:if test="${e.image != null && e.image.startsWith('https') == true}">
                                                <img class="img-fluid" src="${e.image}" alt="${e.lastName}"/>
                                            </c:if>
